...
public class Lab7b extends JFrame {

    private final String pathToClip = "soundLab7/gemilang.wav";
    ...
    public void paint(Graphics g) {
        ...
        Image i = t.getImage("imgLab7/Gemilang.png"); // Load the image from source folder
        g.drawImage(i, 75, 40, 150, 150, this); // Draw the image with specific dimensions
    }

    public void initialize() {
        // Add the label
        JLabel nowPlayingLabel = new JLabel("Now Playing: Gemilang.wav");
